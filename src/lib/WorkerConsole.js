...
if (this.console && this.console.log) {
    ...
    this.Worker = function Worker(url) {
        ...
        var w = new _Worker("lib/WorkerConsole.js#" + url);
    ...
    self.onmessage = function(e) {
        if (e.data === "console") {
            ...
            var workerLocation = url.substring(0, url.lastIndexOf('/')) + '/';
            ...
            self.importScripts = function(url) {
               if(url[0] === '/') {
                  ...
                  _importScripts(workerLocation + url); 
               }
            };

            _importScripts(url);                   // Load and run it now
        }
    };
}
